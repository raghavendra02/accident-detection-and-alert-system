...
void loop()
{
	...
	tobesend = "https://api.callmebot.com/signal/send.php?"; // https://api.callmebot.com/signal/send.php?phone=+917406791338&apikey=989296&text=This+is+a+test
	tobesend = tobesend + "phone=+917406791338";
  ...
  if (abs(x_accel_read) > 4 || abs(y_accel_read) > 4 || abs(z_accel_read) > 4){
    ...
    tobesend = tobesend + gpsStr;
  	tobesend = tobesend + "&apikey=989296";
